...
track = p.loadSDF("racecar_v2/envs/f10_racecar/meshes/barca_track.sdf", globalScaling=1)
otherCar = p.loadURDF("racecar_v2/envs/f10_racecar/racecar_differential.urdf", [0,1,.3])
car = p.loadURDF("racecar_v2/envs/f10_racecar/racecar_differential.urdf", [0,0,.3])
